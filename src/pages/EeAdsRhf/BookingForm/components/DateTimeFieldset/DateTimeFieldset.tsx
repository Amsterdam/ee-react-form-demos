...
const DateTimeFieldset = ({
  ...
  const errorMessage = useMemo(() => {
    ...
    const formatFields = (fields: string[]) => {
      ...
      if (fields.length === 1) {
        return `Het veld ${fieldNameMap[fields[0] as keyof typeof fieldNameMap]} is verplicht.`;
      }

      return `De velden ${fieldNameMap[fields[0] as keyof typeof fieldNameMap]} en ${fieldNameMap[fields[1] as keyof typeof fieldNameMap]} zijn verplicht.`;
    };
